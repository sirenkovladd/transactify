export const categoriesMap = {
  ...
  "home goods": ["CANADIAN TIRE", "YOUR DOLLAR STORE", "VALUE VILLAGE", "MICHAELS", "DOLLARAMA", "SALARMY", "HCM*CARSON BOOKS INC", "Smart N Save", "The Best Shop", "Popeyes"],
  "toiletries": [],
  "presents": ["PET VALU CANADA INC.", "APPLE.COM/CA", "SP DBCANADA", "BLUMEN FLORALS"],
